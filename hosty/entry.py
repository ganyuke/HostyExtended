"""Shared application entry point for Hosty."""
...
def configure_frozen_gtk_environment() -> None:
...
def format_missing_gtk_message() -> str:
    if sys.platform == "win32":
        return (
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        configure_frozen_gtk_environment()
        ...
        if exc.name == "gi":
            print(format_missing_gtk_message(), file=sys.stderr)
            return 2
